...
import { formatPrice, ownershipLabel, statusLabel, type Villa } from "@/data/villas";
      ...
      <Link href={`/villas/${villa.id}`} className="block">
        <div className="relative overflow-hidden">
          ...
          <div className="absolute top-0 left-0 flex flex-wrap gap-px">
            <span className="eyebrow bg-paper/95 text-olive-900 px-2.5 py-1.5">
              {villa.dealType === "sale" ? "Продажа" : "Аренда"}
            </span>
        ...
        <div className="pt-4">
          <div className="flex items-baseline justify-between gap-4 border-b border-rule pb-3">
            ...
            <p className="font-[family-name:var(--font-display)] text-lg whitespace-nowrap">
              {formatPrice(villa)}
            </p>
          </div>
